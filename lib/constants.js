...
export const PACKAGE_NAME = "snowflake-buddy";
...
export const PACKAGE_CONFIGS = {
  delayBetweenRuns: {
    ...
    description:
      "'snowflake-css report' will run on your active project no more frequently than X seconds.",
    type: "integer",
    default: 60,
    minimum: 5,
  },
  hextailTransparency: {
    ...
    description:
      'Semi-transparency provides visual feedback for valid flakes.<br>example: flake-a1234 -> "a1234" will be dimmed by X%.',
    type: "integer",
    default: 50,
    minimum: 0,
    maximum: 99,
  ...
  notifications: {
    ...
    properties: {
      [BIG_BROTHER]: {
        ...
        description:
          "When enabled, typing an new flake will produce a notification.",
        type: "boolean",
        default: false,
      },
      [HEXTAIL]: {
        ...
        description:
          "When enabled, running flake hextail generation will produce a notification.",
        type: "boolean",
        default: false,
      },
      [SNOWFLAKE]: {
        ...
        description:
          "Display info and errors from running the snowflake-css cli tool. Can be helpful for troubleshooting.",
        type: "boolean",
        default: false,
      },
    },
