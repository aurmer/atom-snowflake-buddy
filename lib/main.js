...
export default {
  ...
  activate (state) {
    ...
    this.subscriptions.add(atom.workspace.observeActiveTextEditor(flakeDecorator.watchFile))
  ...
  addSubscriptionTextEditor (textEditor) {
    if (atom.workspace.isTextEditor(textEditor)) {
      if (!textEditor.snowflakeIsHooked) {
        ...
        this.subscriptions.add(textEditor.getBuffer().onDidChange(flakeDecorator.watchChanges.bind(null, textEditor)))
