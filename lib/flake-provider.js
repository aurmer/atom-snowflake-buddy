...
import { PACKAGE_NAME,CONFIG_FILE_NAME,BIG_BROTHER_QUEUE_SIZE,NOTIFICATION_MESSAGE_PREFIX,SnowflakeProject,SeenFile } from "./constants.js"
...
*/
	...
	cursorWatch = (textEditor) => {
		...
		console.log(`watched cursor: ${cursorCount}`)
		if(cursorCount > 1) {
			this.deactivate()
		}
		else {
	...
	bigBrotherWatch = (bufferChange) => {
		if(this.bigBrotherIsActive) {
			console.log(this.bigBrotherIsActive)
