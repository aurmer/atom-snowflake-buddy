...
assert.deepEqual(getAllFlakes(`a-217ba `),[`a-217ba`])
assert.deepEqual(getAllFlakes('flake-7df0c,foo-ef1c5,aa-f2df0-bar-b5e2f[button-554c8].nav-998bf,invalid-f54eee\nnewline-f56c0\nsection-ccc85,invalid-hex-1111,invalid-hex-aaaa'),
