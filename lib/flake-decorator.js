...
export default {
  watchFile: (textEditor) => {
    ...
    if (textEditor.flakeMarkerLayerId) {
      mkLay = textEditor.getMarkerLayer(textEditor.flakeMarkerLayerId);
      ...
      textEditor.flakeMarkerLayerId = mkLay.id;
    }
